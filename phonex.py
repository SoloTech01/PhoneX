...
""")
                ...
                if country == "1":
                        ...
                        try:
                                with open(os.path.join(path, "France phone numbers"), "w") as file:
                                        file.write(valid_phone_numbers)
                                        print(f"\n[✓] FILE SAVED SUCCESSFULLY!: {path}/France phone numbers ")
                        except:
                                pass

                        try:
                                with open("France phone numbers", "w") as file2:
                                        file2.write(valid_phone_numbers)
                                        print(f"[✓] FILE SAVED SUCCESSFULLY!: {Path.cwd()} ")
                        except:
                                pass
                        ...
                        try:
                                with open(os.path.join(path, "Italy phone numbers"), "w") as file:
                                        file.write(valid_phone_numbers)
                                        print(f"\n[✓] FILE SAVED SUCCESSFULLY!: {path}/Italy phone numbers ")
                        except:
                                pass

                        try:
                                with open("Italy phone numbers", "w") as file2:
                                        file2.write(valid_phone_numbers)
                                        print(f"[✓] FILE SAVED SUCCESSFULLY!: {Path.cwd()} ")
                        except:
                                pass
